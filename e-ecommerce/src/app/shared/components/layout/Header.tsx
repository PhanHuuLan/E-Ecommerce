...
const Header: React.FC = () => {
  ...
  const quantityCart = cart.reduce((total : number, item : IProduct) => total + item.quantity, 0);
  ...
  return (
    <header>
          ...
          <div className="header-top-wrapper">
            ...
            <ul className="user-menu-list">
              <li className="user-menu-item">
                <a href="" className="header-link">
                  <p className="header-help">Help</p>
                </a>
              </li>
              <li className="user-menu-item">
                <a href="" className="header-link">
                  <p className="header-joinUs">Join Us</p>
                </a>
              </li>
              <li className="user-menu-item">
                <a href="" className="header-link">
                  <p className="header-Sing">Sign in</p>
                </a>
              </li>
            </ul>
          </div>
      ...
      <section className="header-main">
        <div className="container">
          ...
          <ul className="header-main-list">
            ...
            <li className="header-main-item">
              <a href="/cart/all" className="header-link">
      ...
      <section className="header-bottom">
        <div className="container">
          <p className="header-bottom-title">Hello Nike App</p>
